...
const char* HELP = "Usage: INLretro [options]\n\n"
                   ...
                   "  --console=console, -c console                Console: GB/C (dmg, gb, gbc),\n"
                   "                                                        GBA (gba),\n"
                   "                                                        GENESIS (genesis, gen, megadrive, md),\n"
                   "                                                        NES/Famicom (nes, famicom, fc),\n"
                   "                                                        N64 (n64)\n"
                   "                                                        SNES (snes, sfc),\n"
                   "  --mapper=mapper, -m mapper                   NES:    action53, bnrom,\n"                                       //, cdream, cninja, cnrom, dualport,\n"
                   "                                                       nfs_512, fme7, mapper30, mmc1, mmc2, mmc3, mmc4, mmc5,\n" // easynsf
                   "                                                       nrom, rainbow, unrom, vrc6a, vrc6b, jaleco_ss88006,\n"
                   "                                               GB/C:   mbc1, mbc1_discrete, mbc5\n"
                   "                                               SNES:   auto (LoROM, HiROM auto detection)\n"
                   "                                               GENESIS:32mb, ssf2\n" //, rainbow\n"
