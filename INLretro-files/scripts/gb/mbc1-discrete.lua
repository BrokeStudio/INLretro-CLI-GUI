...
local function rom_manf_id()
  ...
  dict.gameboy("GAMEBOY_PIN31_WR", 0x5555, 0x90)
...
local function ram_test(debug)
  ...
  -- set bank 0
  dict.gameboy("GAMEBOY_WR", 0x4000, 0x00)
...
local function ram_exercise(ram_size, retroprog_id, debug)
  ...
  -- open file
  local filename = "ignore/gb_ram_dump-" .. retroprog_id .. ".bin"
