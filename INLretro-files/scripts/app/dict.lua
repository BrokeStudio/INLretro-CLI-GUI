...
local function pinport(opcode, operand, misc, data)
  ...
  assert((error_code == err_codes["SUCCESS"]),
    ...
    opcode .. " operand: " .. operand .. " misc: " .. misc .. " device error code: " .. error_code)
...
local function bootload(opcode, operand, misc, data, permiterror)
  ...
  if not permiterror then
    ...
    if error_code ~= err_codes["SUCCESS"] then
      print("Permitted Error with opcode: " ..
        opcode .. " operand: " .. operand .. " misc: " .. misc .. " device error code: " .. error_code)
    end
  end
...
create_dict_tables(op_pinport, shared_path .. "shared_dict_pinport.h")
create_dict_tables(op_buffer, shared_path .. "shared_dict_buffer.h")
create_dict_tables(op_io, shared_path .. "shared_dict_io.h")
...
create_dict_tables(op_bootload, shared_path .. "shared_dict_bootload.h")
create_dict_tables(op_fwupdate, shared_path .. "shared_dict_fwupdate.h")
create_dict_tables(op_ciccom, shared_path .. "shared_dict_ciccom.h")
create_dict_tables(op_stuff, shared_path .. "shared_dict_stuff.h")
create_dict_tables(err_codes, shared_path .. "shared_errors.h")
