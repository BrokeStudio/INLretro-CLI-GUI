...
local devices       = {
  ...
  { manufacturer_id = 0xAD, id = 0x23,     part_number = "HY29F400 / AMI29F400AB (top boot block)",    size = 512 },
  { manufacturer_id = 0xAD, id = 0xAB,     part_number = "HY29F400 / AMI29F400AB (bottom boot block)", size = 512 },
  { manufacturer_id = 0xAD, id = 0x2223,   part_number = "HY29F400 / AMI29F400AB (top boot block)",    size = 512 },
  { manufacturer_id = 0xAD, id = 0x22AB,   part_number = "HY29F400 / AMI29F400AB (bottom boot block)", size = 512 },
