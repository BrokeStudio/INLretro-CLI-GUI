...
//operand: value to place on bus
//============================
#define	DATA16_ENABLE_	30
//#define	DATA16_IP_PU_	31
#define	DATA16_IP_	32
#define	DATA16_OP_	33
#define	DATA16_SET_	34
#define	DATA16_RD_ 	35	//RL=4 (error code, data length, databyte)
